...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <title> </title>
    <link href="{!! asset('dist/css/email.css') !!}" rel="stylesheet" type="text/css">
...
<!--<![endif]-->
        ...
        <tbody><tr>
          <td style="padding: 0;width: 560px;">
            <div class="header__logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;">
              <div class="logo-center" style="font-size:0px !important;line-height:0 !important;" align="center" id="emb-email-header"><img style="height: auto;width: 100%;border: 0;max-width: 226px;" src="https://i1.createsend1.com/ei/i/06/F09/A82/182802/csfinal/sidelogo.png" alt="" width="226" height="88"></div>
            </div>
          </td>
        </tr>
      </tbody></table>
              ...
              <td class="column" style='padding: 0;text-align: left;vertical-align: top;color: #60666d;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;width: 600px;'>
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;">
                        <h2 class="size-24" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #44a8c7;font-size: 24px;line-height: 32px;text-align: center;">
                            Welcome to Sidelines.asia!
                        </h2>
                        <p class="size-16" style="Margin-top: 16px;Margin-bottom: 0;font-size: 16px;line-height: 24px;text-align: center;">
                            A Job-Matching Platform for College Students with Teacher Recommendations for Internship/Entry-Level Positions
                        </p>
                        <p class="size-14" style="Margin-top: 20px;Margin-bottom: 0;font-size: 14px;line-height: 21px;text-align: left;">

                            @if($user['user_type'] === 's' || $user['user_type'] === 'd' || $user['user_type'] === 'f')
                                {{ $user->userable->fname . " " . $user->userable->lname }}
                            @elseif($user['user_type'] === 'c')
                                {{ $user->userable->company_name }}
                            @elseif($user['user_type'] === 'sa')
                                {{ $user->userable->school_name }}
                            @endif
                            has registered.
                        </p>

                        <p> Profile link: </p>
                        <a href="{{ URL::route('users.show', $user['id']) }}" style="Margin-top: 20px;Margin-bottom: 0;">
                            <p> {{ $user['email'] }} </p> <br/>
                        </a>
                        <p style="Margin-top: 20px;Margin-bottom: 0;">
                            If you have any questions, please feel free to contact us at sidelinesasia@gmail.com.
                        </p>
                        <p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;</p>
                        <p style="Margin-top: 20px;Margin-bottom: 0;">Cheers!</p>
                        <p style="Margin-top: 20px;Margin-bottom: 20px;">Sidelines Team</p>
                    </div>

                    <div style="Margin-left: 20px;Margin-right: 20px;">
                      <div class="divider" style="display: block;font-size: 2px;line-height: 2px;width: 40px;background-color: #b1c1d8;Margin-left: 260px;Margin-right: 260px;Margin-bottom: 20px;">&nbsp;</div>
                    </div>

                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                      <div style="line-height:46px;font-size:1px">&nbsp;</div>
                    </div>
              </td>
            </tr>
        </tbody>
            ...
            <table class="footer__left" style='border-collapse: collapse;table-layout: fixed;border-spacing: 0;color: #b9b9b9;font-family: "Open Sans",sans-serif;width: 380px;'>
              <tbody><tr>
                <td class="footer__inner" style="padding: 0;font-size: 12px;line-height: 19px;">
                      ...
                      <tbody>
                          <tr>
                            <td class="emb-web-links" style="padding: 0;width: 26px;">
                                <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #b9b9b9;" href="http://sidelines.createsend1.com/t/i-l-hjhthit-l-r/">
                                    <img style="border: 0;" src="https://i1.createsend1.com/static/eb/master/13-the-blueprint-3/images/facebook.png" width="26" height="26">
                                </a>
                            </td>
                            <td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;">
                                <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #b9b9b9;" href="http://sidelines.createsend1.com/t/i-l-hjhthit-l-j/">
                                    <img style="border: 0;" src="https://i10.createsend1.com/static/eb/master/13-the-blueprint-3/images/twitter.png" width="26" height="26">
                                </a>
                            </td>
                            <td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;">
                                <a style="text-decoration:underline;transition: opacity 0.1s ease-in;color: #b9b9b9;" href="http://sidelines.createsend1.com/t/i-l-hjhthit-l-t/">
                                    <img style="border: 0;" src="https://i5.createsend1.com/static/eb/master/13-the-blueprint-3/images/website.png" width="26" height="26">
                                </a>
                            </td>
                        </tr>
                    </tbody>
                  ...
                  <div>
                    <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #b9b9b9;" href="http://sidelines.createsend1.com/t/i-u-hjhthit-l-i/">Unsubscribe</a>
                  </div>
                </td>
              </tr>
            </tbody></table>
  ...
  <img style="visibility: hidden !important; display: block !important; height:1px !important; width:1px !important; border: 0 !important; margin: 0 !important; padding: 0 !important" src="https://sidelines.createsend1.com/t/i-o-hjhthit-l/o.gif" width="1" height="1" border="0" alt="">
</body></html>
